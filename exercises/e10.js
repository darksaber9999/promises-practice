...
// Your code goes here...
export function handlePromise2(array) {
  return Promise.any(array).catch((e) => e);
}
...
// Your code goes here...
export function handlePromise3(array) {
  return Promise.allSettled(array).then((values) => values);
}
